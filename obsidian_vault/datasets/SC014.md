...
- Number of cells or spots: 210000.0
- Number of genes: 20250

## Data availability

- Data level: h5ad
- Data access: public
- Primary data path: /data/ulukoy/ovarian_cancer/data/2022_Zhang/a_data_raw/annotated/2022_Zhang_rawmtx.h5ad.gz
- Metadata path: 
- QC report path: 
