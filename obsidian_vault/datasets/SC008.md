...
- Number of cells or spots: 45000.0
- Number of genes: 19200

## Data availability

- Data level: h5ad
- Data access: public
- Primary data path: /data/ulukoy/ovarian_cancer/data/2021_Hippen/a_data_raw/annotated/2021_Hippen_rawmtx.h5ad.gz
- Metadata path: 
- QC report path: 
