...
- Number of cells or spots: 69000.0
- Number of genes: 18900

## Data availability

- Data level: h5ad
- Data access: public
- Primary data path: /data/ulukoy/ovarian_cancer/data/2022_Junfen/a_data_raw/annotated/2022_Junfen_rawmtx.h5ad.gz
- Metadata path: 
- QC report path: 
