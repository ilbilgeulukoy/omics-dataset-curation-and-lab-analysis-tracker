...
- Number of cells or spots: 145000.0
- Number of genes: 20300

## Data availability

- Data level: h5ad
- Data access: public
- Primary data path: /data/ulukoy/ovarian_cancer/data/2021_Regner/a_data_raw/annotated/2021_Regner_rawmtx.h5ad.gz
- Metadata path: 
- QC report path: 
